...
export class AdminController {
  ...
  @Post('admin/tests/:testDefinitionId/questions') @UseGuards(AdminApiKeyGuard) uploadQuestions(@Param('testDefinitionId') testDefinitionId: string, @Body() dto: UploadQuestionsDto) { return this.admin.uploadQuestions(testDefinitionId, dto); }
  @Patch('admin/questions/:id') @UseGuards(AdminApiKeyGuard) updateQuestion(@Param('id') id: string, @Body() dto: UpdateQuestionDto) { return this.admin.updateQuestion(id, dto); }
}
